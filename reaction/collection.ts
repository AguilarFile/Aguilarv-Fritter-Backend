...
class ReactionCollection {
    ...
    static async deleteOne(user: Types.ObjectId | String, freet: Types.ObjectId | String, type: String): Promise<Boolean> {
    ...
    static async findOne(user: Types.ObjectId | String, freet: Types.ObjectId | String, type: String): Promise<HydratedDocument<Reaction>> {
